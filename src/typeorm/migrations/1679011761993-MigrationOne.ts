...
export class MigrationOne1679011761993 implements MigrationInterface {
    name = 'MigrationOne1679011761993'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "favorites" ("id" SERIAL NOT NULL, "artistsIds" text array NOT NULL DEFAULT '{}', "albumsIds" text array NOT NULL DEFAULT '{}', "tracksIds" text array NOT NULL DEFAULT '{}', CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "login" character varying NOT NULL, "password" character varying NOT NULL, "version" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "refreshToken" character varying, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "favorites_artists_artists" ("favoritesId" integer NOT NULL, "artistsId" uuid NOT NULL, CONSTRAINT "PK_66223ae7b354407f1992d1569e5" PRIMARY KEY ("favoritesId", "artistsId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "favorites_albums_albums" ("favoritesId" integer NOT NULL, "albumsId" uuid NOT NULL, CONSTRAINT "PK_64a7bf3ac232299b01062463fc0" PRIMARY KEY ("favoritesId", "albumsId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "favorites_tracks_tracks" ("favoritesId" integer NOT NULL, "tracksId" uuid NOT NULL, CONSTRAINT "PK_e1d7ed5b143827263347ad6c43a" PRIMARY KEY ("favoritesId", "tracksId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_cdb702f7ae63243bc8ffda8e0a" ON "favorites_tracks_tracks" ("favoritesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a68f39bdfc7688558ab5a2f389" ON "favorites_tracks_tracks" ("tracksId") `);
        ...
        await queryRunner.query(`ALTER TABLE "favorites_tracks_tracks" ADD CONSTRAINT "FK_cdb702f7ae63243bc8ffda8e0aa" FOREIGN KEY ("favoritesId") REFERENCES "favorites"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "favorites_tracks_tracks" ADD CONSTRAINT "FK_a68f39bdfc7688558ab5a2f3892" FOREIGN KEY ("tracksId") REFERENCES "tracks"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "favorites_tracks_tracks" DROP CONSTRAINT "FK_a68f39bdfc7688558ab5a2f3892"`);
        await queryRunner.query(`ALTER TABLE "favorites_tracks_tracks" DROP CONSTRAINT "FK_cdb702f7ae63243bc8ffda8e0aa"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_a68f39bdfc7688558ab5a2f389"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cdb702f7ae63243bc8ffda8e0a"`);
